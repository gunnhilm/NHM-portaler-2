...
const textItems = {
    ...
    serverErrorObj: ["Serverfeil, prøv nytt søk. Maks antall objekter man kan søke på er ca. 1000. ", "Server error, try new search. Maximum number of objects possible to search for is ca. 1000."],
